...
// all you have to do is to add these libraries into your pubspec.yaml
// sqflite: <newest version>
// path_provider: <newest version>

// and import from where you saved this dart file
...
//IMPORTENT NOTE: to get any number for examble 7.0 as is and not lose the ".0" and only get 7 use [name1] [name2] as key
//you can only use [name1] [name2] so use them wisely
// setIntValue()async{
//    await dbHelper.setReal('name1',7.0);
// }
//
// setIntValue()async{
